...
const int pwmPIN[]={2,3,4,7}; // an array to identify the PWM input pins (the array can be any length) 
...
int RC_min[4] = { 1044,   1080,   1124,   1064};
int RC_mid[4] = { 1500,   1500,   1500,   1500};
int RC_max[4] = { 1940,   1872,   1804,   1992};
...
//    else if(pwmPIN[i] == 7)                                         pwmPIN_reg[i] = 0b10000000;
    ...
    if(pwmPIN[i] == 0 || pwmPIN[i] == A0)         pwmPIN_reg[i] = 0b00000001;
    else if(pwmPIN[i] == 1 || pwmPIN[i] == A1)    pwmPIN_reg[i] = 0b00000010;
    else if(pwmPIN[i] == 2 || pwmPIN[i] == A2 || pwmPIN[i] == 10)   pwmPIN_reg[i] = 0b00000100;
    else if(pwmPIN[i] == 3 || pwmPIN[i] == A3)   pwmPIN_reg[i] = 0b00001000;
    else if(pwmPIN[i] == 4 || pwmPIN[i] == A4 || pwmPIN[i] == 12)   pwmPIN_reg[i] = 0b00010000;
    else if(pwmPIN[i] == A5)   pwmPIN_reg[i] = 0b00100000;
//    else if(pwmPIN[i] == 6)                                         pwmPIN_reg[i] = 0b01000000;
    else if(pwmPIN[i] == 7)                                         pwmPIN_reg[i] = 0b10000000;
