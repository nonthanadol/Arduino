...
void setup() {
    ...
    servo1.attach(servo1_pin, 1000, 2000); // attach the servo library to each servo pin, and define min and max uS values
...
int calc_uS(float cmd, int servo){                                // cmd = commanded position +-100% 
  ...
  if(cmd > 2000) cmd = 2000;                                      // limit pulsewidth to the range 500 to 2500us
  else if(cmd < 1000) cmd = 1000;
